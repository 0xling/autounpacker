...
class pydbg:
    ...
    def enumerate_modules (self):
        ...
        @rtype:  List
        @return: List of module name / base address / size / exe path tuples.
        '''
        ...
        while found_mod:
            module_list.append((module.szModule, module.modBaseAddr, module.modBaseSize, module.szExePath))
